      ...
      >
        ...
        <div className="relative z-10 flex flex-col pb-24 md:pb-28">
          ...
          <div className="space-y-1">
            <Link to={href} className="rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60">
              <h2
          ...
          {!expanded && (
            <div className="relative mt-4 flex justify-center">
              ...
              <Link to={href} className="rounded-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60">
                <div
        ...
        <div className="pointer-events-none absolute bottom-4 left-8 right-8 z-20">
          <div className="flex items-center gap-3 translate-y-6 opacity-0 transition-all duration-300 ease-out group-hover:translate-y-0 group-hover:opacity-100 group-focus-within:translate-y-0 group-focus-within:opacity-100 pointer-events-auto">
            ...
            <div className="ml-auto flex items-center gap-2.5">
              <button
                type="button"
                onClick={(event) => handleAuxiliaryClick(event, 'Mostrando opciones', 'warning', <MoreHorizontal className="h-4 w-4" strokeWidth={1.75} />)}
